...
// <auto-generated>
//  This code was generated by the following tool on 2023-12-07 13:17:05 GMT-05:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern void account_execute_raw(Account* account, Call* calldata, UIntPtr calldata_len, Error* error);
        ...
        public static extern Account* account_new(CString rpc_url, FieldElement private_key, CString address, Error* error);
        ...
        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_add_entities_to_sync", CallingConvention = CallingConvention.Cdecl)]
        public static extern void client_add_entities_to_sync(ToriiClient* client, KeysClause* entities, UIntPtr entities_len, Error* error);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_entities", CallingConvention = CallingConvention.Cdecl)]
        public static extern CArray_Entity client_entities(ToriiClient* client, Query* query, Error* error);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_entity", CallingConvention = CallingConvention.Cdecl)]
        public static extern Ty* client_entity(ToriiClient* client, KeysClause* keys, Error* error);
        ...
        public static extern ToriiClient* client_new(CString torii_url, CString rpc_url, CString world, KeysClause* entities, UIntPtr entities_len, Error* error);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_entity_state_update", CallingConvention = CallingConvention.Cdecl)]
        public static extern void client_on_entity_state_update(ToriiClient* client, KeysClause* entity, FnPtr_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_remove_entities_to_sync", CallingConvention = CallingConvention.Cdecl)]
        public static extern void client_remove_entities_to_sync(ToriiClient* client, KeysClause* entities, UIntPtr entities_len, Error* error);
        ...
        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_subscribed_entities", CallingConvention = CallingConvention.Cdecl)]
        public static extern CArray_KeysClause client_subscribed_entities(ToriiClient* client);
        ...
        public static extern FieldElement felt_from_hex_be(CString hex, Error* error);
