...
var ASM_CONSTS = {
  2583408: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2583469: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2583533: function() {return Module.webglContextAttributes.powerPreference;},  
 2583591: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2583646: function($0) {performance.now = function() { return $0; };},  
 2583694: function($0) {performance.now = function() { return $0; };},  
 2583742: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _GetEntities(clientPtr, limit, offset, cb) {
      var client = wasm_bindgen.Client.__wrap(clientPtr);
  ...
  async function _GetEntitiesByKeys(
      clientPtr,
      model,
      keys,
      limit,
...
var asmLibraryArg = {
  ...
  "GetEntitiesByKeys": _GetEntitiesByKeys,
