...
// <auto-generated>
//  This code was generated by the following tool on 2025-09-05 15:31:32 GMT+01:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_token_collections", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultPageTokenCollection client_token_collections(ToriiClient* client, TokenBalanceQuery query);
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct CArrayTokenCollection
        {
            [FieldOffset(0)] // size = 8
            public TokenCollection* data;
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 32, Pack = 8)]
        public struct PageTokenCollection
        {
            [FieldOffset(0)] // size = 16
            public CArrayTokenCollection _items;

            public Span<TokenCollection> items
            {
                get
                {
                    fixed (PageTokenCollection* @this = &this)
                    {
                        var span = new Span<TokenCollection>(@this->_items.data, (int)@this->_items.data_len);
                        return span;
                    }
                }
                ...
                set
                {
                    ...
                    _items = new CArrayTokenCollection();
                    _items.data_len = (UIntPtr)value.Length;
                    fixed (TokenCollection* ptr = value)
                    {
                        _items.data = ptr;
                    }
                }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 40, Pack = 8)]
        public struct ResultPageTokenCollection
        {
            [FieldOffset(0)] // size = 4
            public ResultPageTokenCollection_Tag tag;

            [FieldOffset(8)] // size = 32
            public PageTokenCollection ok;
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 32, Pack = 8)]
        public struct ResultPageTokenCollection_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 32
            public PageTokenCollection ok;
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 32, Pack = 8)]
        public struct ResultPageTokenCollection_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 32
            public PageTokenCollection ok;
        }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultPageTokenCollection_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        [CNode(Kind = "Enum")]
        public enum ResultPageTokenCollection_Tag : int
        {
            OkPageTokenCollection = 0,
            ErrPageTokenCollection = 1
        }
