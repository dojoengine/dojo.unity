...
// <auto-generated>
//  This code was generated by the following tool on 2025-04-23 17:07:09 GMT+09:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern ResultCArrayEntity client_entities(ToriiClient* client, Query* query, CBool historical);
        ...
        public static extern ResultSubscription client_on_event_message_update(ToriiClient* client, EntityKeysClause* clauses, UIntPtr clauses_len, FnPtr_FieldElement_CArrayStruct_Void callback);
        ...
        public static extern ResultCArrayTokenBalance client_token_balances(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len, FieldElement* account_addresses, UIntPtr account_addresses_len, U256* token_ids, UIntPtr token_ids_len);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_tokens", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultCArrayToken client_tokens(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len, U256* token_ids, UIntPtr token_ids_len);
        ...
        public static extern Resultbool client_update_event_message_subscription(ToriiClient* client, Subscription* subscription, EntityKeysClause* clauses, UIntPtr clauses_len);
        ...
        public struct Query
        {
            ...
            public CArrayc_char _entity_models;

            public Span<string> entity_models
            {
                get
                {
                    fixed (Query* @this = &this)
                    {
                        var span = new Span<CString>(@this->_entity_models.data, (int)@this->_entity_models.data_len);
                        return span.ToArray().Select(str => CString.ToString(str)).ToArray();
                    }
                }
                ...
                {
                    var strings = value.ToArray().Select(str => CString.FromString(str)).ToArray();
                    _entity_models = new CArrayc_char();
                    _entity_models.data_len = (UIntPtr)value.Length;
                    fixed (CString* ptr = strings)
                    {
                        _entity_models.data = ptr;
                    }
                }
            }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 24, Pack = 8)]
        public struct ResultCArrayToken
        {
            [FieldOffset(0)] // size = 4
            public ResultCArrayToken_Tag tag;

            [FieldOffset(8)] // size = 16
            public CArrayToken _ok;

            public Span<Token> ok
            {
                get
                {
                    fixed (ResultCArrayToken* @this = &this)
                    {
                        var span = new Span<Token>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
                }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 24, Pack = 8)]
        public struct ResultCArrayTokenBalance
        {
            [FieldOffset(0)] // size = 4
            public ResultCArrayTokenBalance_Tag tag;

            [FieldOffset(8)] // size = 16
            public CArrayTokenBalance _ok;

            public Span<TokenBalance> ok
            {
                get
                {
                    fixed (ResultCArrayTokenBalance* @this = &this)
                    {
                        var span = new Span<TokenBalance>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
                }
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayTokenBalance_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 16
            public CArrayTokenBalance _ok;
            ...
            public Span<TokenBalance> ok
            {
                get
                {
                    fixed (ResultCArrayTokenBalance_ANONYMOUS_FIELD1* @this = &this)
                    {
                        var span = new Span<TokenBalance>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayTokenBalance_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 16
            public CArrayTokenBalance _ok;
            ...
            public Span<TokenBalance> ok
            {
                get
                {
                    fixed (ResultCArrayTokenBalance_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0* @this = &this)
                    {
                        var span = new Span<TokenBalance>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultCArrayTokenBalance_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayToken_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 16
            public CArrayToken _ok;
            ...
            public Span<Token> ok
            {
                get
                {
                    fixed (ResultCArrayToken_ANONYMOUS_FIELD1* @this = &this)
                    {
                        var span = new Span<Token>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayToken_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 16
            public CArrayToken _ok;
            ...
            public Span<Token> ok
            {
                get
                {
                    fixed (ResultCArrayToken_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0* @this = &this)
                    {
                        var span = new Span<Token>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultCArrayToken_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        [CNode(Kind = "Enum")]
        public enum ResultCArrayTokenBalance_Tag : int
        {
            OkCArrayTokenBalance = 0,
            ErrCArrayTokenBalance = 1
        }

        [CNode(Kind = "Enum")]
        public enum ResultCArrayToken_Tag : int
        {
            OkCArrayToken = 0,
            ErrCArrayToken = 1
        }
