...
// <auto-generated>
//  This code was generated by the following tool on 2024-07-08 12:29:16 GMT+02:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern Resultbool client_add_models_to_sync(ToriiClient* client, ModelKeysClause* models, UIntPtr models_len);
        ...
        public static extern ResultSubscription client_on_entity_state_update(ToriiClient* client, EntityKeysClause* clause, FnPtr_FieldElement_CArrayStruct_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_event_message_update", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultSubscription client_on_event_message_update(ToriiClient* client, EntityKeysClause* clause, FnPtr_FieldElement_CArrayStruct_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_sync_model_update", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultSubscription client_on_sync_model_update(ToriiClient* client, ModelKeysClause model, FnPtr_Void callback);
        ...
        public static extern FieldElement hash_get_contract_address(FieldElement class_hash, FieldElement salt, int* constructor_calldata, UIntPtr constructor_calldata_len, FieldElement deployer_address);
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct CArrayModelKeysClause
        {
            [FieldOffset(0)] // size = 8
            public ModelKeysClause* data;
        ...
        public struct ModelKeysClause
        {
            ...
            public Span<FieldElement> keys
            {
                get
                {
                    fixed (ModelKeysClause* @this = &this)
                    {
