...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern ResultCArrayToken client_tokens(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len);
        ...
        public static extern ResultController controller_account(Policy* policies, UIntPtr policies_len, FieldElement chain_id);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_address", CallingConvention = CallingConvention.Cdecl)]
        public static extern FieldElement controller_address(Controller* controller);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_chain_id", CallingConvention = CallingConvention.Cdecl)]
        public static extern FieldElement controller_chain_id(Controller* controller);
        ...
        public static extern void controller_connect(CString rpc_url, Policy* policies, UIntPtr policies_len, FnPtr_ControllerPtr_Void account_callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_execute_from_outside", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultFieldElement controller_execute_from_outside(Controller* controller, Call* calldata, UIntPtr calldata_len);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_execute_raw", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultFieldElement controller_execute_raw(Controller* controller, Call* calldata, UIntPtr calldata_len);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_nonce", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultFieldElement controller_nonce(Controller* controller);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "controller_username", CallingConvention = CallingConvention.Cdecl)]
        public static extern CString controller_username(Controller* controller);
        ...
        [CNode(Kind = "FunctionPointer")]
        [StructLayout(LayoutKind.Sequential)]
        public struct FnPtr_ControllerPtr_Void
        {
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            public unsafe delegate void @delegate(Controller* param);

            public IntPtr Pointer;

            public FnPtr_ControllerPtr_Void(@delegate d)
            {
                Pointer = Marshal.GetFunctionPointerForDelegate(d);
            }
        }
        ...
        {
            [FieldOffset(0)] // size = 4
            public ResultController_Tag tag;

            [FieldOffset(8)] // size = 8
            public Controller* _ok;

            public Controller ok
            {
                get
                {
                    return *_ok;
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultController_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Controller* _ok;
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultController_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 8
            public Controller* _ok;
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultController_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        {
            [FieldOffset(0)] // size = 32
            public fixed byte _balance[32]; // uint64_t[4]

            public Span<ulong> balance
            {
                get
                {
                    fixed (TokenBalance* @this = &this)
                    {
                        var pointer = &@this->_balance[0];
                        var span = new Span<ulong>(pointer, 4);
                        return span;
                    }
                }
            ...
            public CString token_id_;

            public string token_id
            {
                get
                {
                    return CString.ToString(token_id_);
                }
                set
                {
                    token_id_ = CString.FromString(value);
                }
            }
        }
        ...
        [CNode(Kind = "Enum")]
        public enum ResultController_Tag : int
        {
            OkController = 0,
            ErrController = 1
        }
