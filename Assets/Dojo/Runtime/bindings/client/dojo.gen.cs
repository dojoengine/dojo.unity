...
// <auto-generated>
//  This code was generated by the following tool on 2025-04-29 19:50:50 GMT+09:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern ResultCArrayController client_controllers(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len);
        ...
        public static extern ResultWorldMetadata client_metadata(ToriiClient* client);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_new", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultToriiClient client_new(CString torii_url, CString libp2p_relay_url, FieldElement world);
        ...
        public static extern ResultPageTokenBalance client_token_balances(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len, FieldElement* account_addresses, UIntPtr account_addresses_len, U256* token_ids, UIntPtr token_ids_len, uint limit, COptionc_char cursor);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_tokens", CallingConvention = CallingConvention.Cdecl)]
        public static extern ResultPageToken client_tokens(ToriiClient* client, FieldElement* contract_addresses, UIntPtr contract_addresses_len, U256* token_ids, UIntPtr token_ids_len, uint limit, COptionc_char cursor);
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 24, Pack = 8)]
        public struct ResultCArrayController
        {
            [FieldOffset(0)] // size = 4
            public ResultCArrayController_Tag tag;

            [FieldOffset(8)] // size = 16
            public CArrayController _ok;

            public Span<Controller> ok
            {
                get
                {
                    fixed (ResultCArrayController* @this = &this)
                    {
                        var span = new Span<Controller>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
                }
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayController_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 16
            public CArrayController _ok;
            ...
            public Span<Controller> ok
            {
                get
                {
                    fixed (ResultCArrayController_ANONYMOUS_FIELD1* @this = &this)
                    {
                        var span = new Span<Controller>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 16, Pack = 8)]
        public struct ResultCArrayController_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 16
            public CArrayController _ok;
            ...
            public Span<Controller> ok
            {
                get
                {
                    fixed (ResultCArrayController_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0* @this = &this)
                    {
                        var span = new Span<Controller>(@this->_ok.data, (int)@this->_ok.data_len);
                        return span;
                    }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultCArrayController_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 56, Pack = 8)]
        public struct ResultWorldMetadata
        {
            [FieldOffset(0)] // size = 4
            public ResultWorldMetadata_Tag tag;

            [FieldOffset(8)] // size = 48
            public WorldMetadata ok;
        ...
        [CNode(Kind = "Union")]
        [StructLayout(LayoutKind.Explicit, Size = 48, Pack = 8)]
        public struct ResultWorldMetadata_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 48
            public WorldMetadata ok;
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 48, Pack = 8)]
        public struct ResultWorldMetadata_ANONYMOUS_FIELD1_ANONYMOUS_FIELD0
        {
            [FieldOffset(0)] // size = 48
            public WorldMetadata ok;
        }
        ...
        [CNode(Kind = "Struct")]
        [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 8)]
        public struct ResultWorldMetadata_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
        {
            [FieldOffset(0)] // size = 8
            public Error err;
        }
        ...
        [CNode(Kind = "Enum")]
        public enum ResultCArrayController_Tag : int
        {
            OkCArrayController = 0,
            ErrCArrayController = 1
        }
        ...
        [CNode(Kind = "Enum")]
        public enum ResultWorldMetadata_Tag : int
        {
            OkWorldMetadata = 0,
            ErrWorldMetadata = 1
        }
