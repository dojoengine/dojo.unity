...
// <auto-generated>
//  This code was generated by the following tool on 2023-12-28 13:48:40 GMT-05:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern Result_____Account account_deploy_burner(CJsonRpcClient* rpc, Account* master_account);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "account_execute_raw", CallingConvention = CallingConvention.Cdecl)]
        public static extern Result_FieldElement account_execute_raw(Account* account, Call* calldata, UIntPtr calldata_len);
        ...
        public static extern Result_bool wait_for_transaction(CJsonRpcClient* rpc, FieldElement txn_hash);
