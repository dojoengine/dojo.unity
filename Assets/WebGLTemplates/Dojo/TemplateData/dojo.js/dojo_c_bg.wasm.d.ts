...
export const toriiclient_getTokenCollections: (a: number, b: any) => any;
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h859b951bee550a5a: (a: number, b: number) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbd34cb1bbccea715: (a: number, b: number) => void;
export const closure965_externref_shim: (a: number, b: number, c: any) => void;
export const closure1146_externref_shim: (a: number, b: number, c: any, d: any) => void;
