...
export const wasm_bindgen__convert__closures_____invoke__h393ac263d49faac3: (a: number, b: number) => void;
export const closure975_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h18edae019c731a7c: (a: number, b: number) => void;
