...
// <auto-generated>
//  This code was generated by the following tool on 2023-11-30 23:46:38 GMT-05:00:
...
namespace dojo_bindings
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static extern void client_add_entities_to_sync(ToriiClient* client, Keys* entities, UIntPtr entities_len, Error* error);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_entity", CallingConvention = CallingConvention.Cdecl)]
        public static extern Ty* client_entity(ToriiClient* client, Keys* keys, Error* error);
        ...
        public static extern ToriiClient* client_new(CString torii_url, CString rpc_url, CString world, Keys* entities, UIntPtr entities_len, Error* error);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_on_entity_state_update", CallingConvention = CallingConvention.Cdecl)]
        public static extern void client_on_entity_state_update(ToriiClient* client, Keys* entity, FnPtr_Void callback);

        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "client_remove_entities_to_sync", CallingConvention = CallingConvention.Cdecl)]
        public static extern void client_remove_entities_to_sync(ToriiClient* client, Keys* entities, UIntPtr entities_len, Error* error);
        ...
        [CNode(Kind = "Function")]
        [DllImport(LibraryName, EntryPoint = "keys_free", CallingConvention = CallingConvention.Cdecl)]
        public static extern void keys_free(CArray_KeysClause* array);
