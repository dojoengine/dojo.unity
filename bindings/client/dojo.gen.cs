...
// <auto-generated>
//  This code was generated by the following tool on 2023-11-23 11:58:29 GMT-05:00:
...
namespace dojo_namespace
{
    ...
    public static unsafe partial class dojo
    {
        ...
        public static partial void carray_free(CArray_EntityQuery* array);
        ...
        [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
        public static partial void client_on_entity_state_update(ToriiClient* client, EntityQuery* entity, FnPtr_Void callback, Error* error);
        ...
        public struct CompositeClause
        {
            ...
            private CArray_Clause _clauses;

            public readonly Span<Clause> clauses
            {
                get
                {
                    fixed (CompositeClause* @this = &this)
                    {
                        var span = new Span<Clause>(@this->clauses.data, @this->clauses.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct Enum
        {
            ...
            private CArray_EnumOption _options;
            ...
            public readonly Span<EnumOption> options
            {
                get
                {
                    ...
                    {
                        var span = new Span<EnumOption>(@this->options.data, @this->options.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct ModelMetadata
        {
            ...
            private CArray_FieldElement _layout;
            ...
            public readonly Span<FieldElement> layout
            {
                get
                {
                    ...
                    {
                        var span = new Span<FieldElement>(@this->layout.data, @this->layout.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct Struct
        {
            ...
            [FieldOffset(8)] // size = 16
            private CArray_Member _children;
            ...
            public readonly Span<Member> children
            {
                get
                {
                    ...
                    {
                        var span = new Span<Member>(@this->children.data, @this->children.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct Ty
        {
            ...
            public readonly Span<Ty> ty_tuple
            {
                get
                {
                    fixed (Ty* @this = &this)
                    {
                        var span = new Span<Ty>(@this->ty_tuple.data, @this->ty_tuple.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct Value
        {
            ...
            [FieldOffset(0)] // size = 16
            private CArray_u8 _bytes;

            public readonly Span<byte> bytes
            {
                get
                {
                    fixed (Value* @this = &this)
                    {
                        var span = new Span<byte>(@this->bytes.data, @this->bytes.data_len);
                        return span;
                    }
                }
            }
        ...
        public struct Value_ANONYMOUS_FIELD1
        {
            ...
            public readonly Span<byte> bytes
            {
                get
                {
                    fixed (Value_ANONYMOUS_FIELD1* @this = &this)
                    {
                        var span = new Span<byte>(@this->bytes.data, @this->bytes.data_len);
                        return span;
                    }
        ...
        public struct Value_ANONYMOUS_FIELD1_ANONYMOUS_FIELD4
        {
            ...
            public readonly Span<byte> bytes
            {
                get
                {
                    fixed (Value_ANONYMOUS_FIELD1_ANONYMOUS_FIELD4* @this = &this)
                    {
                        var span = new Span<byte>(@this->bytes.data, @this->bytes.data_len);
                        return span;
                    }
        ...
        public struct WorldMetadata
        {
            ...
            private CArray_CHashItem______c_char__ModelMetadata _models;
            ...
            public readonly Span<CHashItem______c_char__ModelMetadata> models
            {
                get
                {
                    ...
                    {
                        var span = new Span<CHashItem______c_char__ModelMetadata>(@this->models.data, @this->models.data_len);
                        return span;
                    }
                }
            }
